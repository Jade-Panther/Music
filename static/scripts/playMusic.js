...
function updateTimerDisplay(){
    ...
    document.getElementById('curr-time').textContent = formatTime(player.getCurrentTime());
...
function updateSongInfo() {
    if(player.getVideoData && playList.length > 0 && player.getPlayerState != undefined && playState === 'playing') {
